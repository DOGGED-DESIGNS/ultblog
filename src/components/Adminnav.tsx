...
export default function Adminnav() {
  ...
  return (
    <nav className=" flex shadow-sm   relative  justify-between  px-6 bg-slate-200  py-4 border-b-2 border-Binactive/60">
      <div
        onClick={() => setToggle(false)}
        className={cn(
          "fixed block  z-[9]  bg-black/0 w-lvw h-lvh top-0 left-0 ",
          {
            "-z-[9]  ": !toggle,
          }
        )}
      ...
      <motion.div
        ...
        className=" absolute z-10 pb-10  top-0 left-0  flex  flex-col  bg-slate-100  w-[300px] pt-10 px-5 h-lvh "
      >
        {/*  mobile nav header */}
